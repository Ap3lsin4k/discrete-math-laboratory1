...
def create_win2():
    ...
    step_but = Button(frame, text='Next', font=('Garamond', 14), bg='light sea green', command=result)
    ...
    save_but = Button(frame, text='Save', font=('Garamond', 14), bg='light sea green',
    ...
    def res():
        ...
        if iterator == len(switch):
            ...
            if len(union2) > 10:
                ...
                return label_d.config(text=('D2=', str(a_intersect_b_diff_c).strip('{}') if len(a_intersect_b_diff_c) > 0 else '∅'))
